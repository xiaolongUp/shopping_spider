...
class ProductInfo(models.Model):
    ...
    vendor = models.CharField(max_length=255, null=True, blank=True, verbose_name='销售商')
    delivery_time = models.CharField(max_length=255, null=True, blank=True, verbose_name='配送时间')
    sku = models.CharField(max_length=255, null=True, blank=True, verbose_name='库存量单位')
    sku1 = models.CharField(max_length=255, null=True, blank=True, verbose_name='库存量单位')
